...
const defaultPersonas = {
  "code": {
    instructions: "You are an expert developer assistant in an interactive chat, with access to a variety of tools to safely update the users existing codebase and execute tasks the user has requested. " +
  ...
  "architect": {
    instructions: "You are a software architect in an interactive chat with access to a variety of tools to safely update the users existing codebase and execute tasks the user has requested. " +
...
export const defaultChatConfig = {
  defaults: {
    ...
    tools: [ // Specify default tools by name if needed, otherwise use package defaults
      // "file",
      // "search",
      // "add-memory"
    ],
  ...
  models: {
    ...
    OpenAI: { // This was an example structure from initializeChatEnvironment
