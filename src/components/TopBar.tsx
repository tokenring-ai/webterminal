    ...
    <nav className="bg-linear-to-r from-gray-900 to-gray-800 border-b border-gray-700 px-4 py-2 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        <button
          ...
          title="Toggle theme"
        >
          {theme === "light" ? <Moon className="w-5 h-5 text-gray-300" /> : <Sun className="w-5 h-5 text-yellow-400" />}
        </button>
        <div className="relative">
          ...
          >
            ...
            {unreadCount > 0 && <span className="absolute top-1 right-1 w-2 h-2 bg-purple-500 rounded-full" />}
          </button>
          {showNotifications && (
        ...
        {loading ? (
          ...
          <button type="button" onClick={signOut} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-700 transition-colors">
          ...
          <button type="button" onClick={() => setShowSignIn(true)} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-700 transition-colors">
            <div className="w-6 h-6 rounded-full bg-linear-to-br from-purple-500 to-indigo-600" />
