		...
		<nav className="bg-gradient-to-r from-gray-900 to-gray-800 border-b border-gray-700 px-4 py-2 flex items-center justify-between">
			...
			<div className="flex items-center space-x-4">
				...
				{loading ? (
					...
					<button onClick={signOut} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-700 transition-colors">
					...
					<button onClick={signIn} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-700 transition-colors">
						<div className="w-6 h-6 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600" />
