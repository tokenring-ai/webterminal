...
type SidebarProps = {
	...
	chatTabs: ChatTab[];
	onNewChat: () => void;
	onSelectTab: (id: string, title: string) => void;
};

function Sidebar({ onFileOpen, chatTabs, onNewChat, onSelectTab }: SidebarProps) {
			...
			<div className="w-16 bg-gray-800 flex flex-col items-center py-4 space-y-6">
				<button
					...
					className={clsx(
						...
						activeTab === "chats" ? "bg-gray-700 text-purple-400" : "text-gray-400 hover:text-white hover:bg-gray-700"
					)}
				>
				...
				<button
					...
					className={clsx(
						"p-3 rounded-lg transition-all duration-200 group relative",
						activeTab === "files" ? "bg-gray-700 text-purple-400" : "text-gray-400 hover:text-white hover:bg-gray-700"
					)}
				>
					<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<button
					...
					className={clsx(
						"p-3 rounded-lg transition-all duration-200 group relative",
						activeTab === "settings" ? "bg-gray-700 text-purple-400" : "text-gray-400 hover:text-white hover:bg-gray-700"
					)}
				>
					<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
