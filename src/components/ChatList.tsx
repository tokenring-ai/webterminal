...
export default function ChatList({ chatTabs, onNewChat, onSelectChatTab }: ChatListProps) {
	...
	return (
		<>
			<h2 className="text-gray-400 text-sm font-semibold mb-4 px-2">RECENT CHATS</h2>
			<div className="space-y-2">
				{chatTabs && chatTabs.map((chatTab: ChatTab) => {
						...
						>
							<div className="flex items-center space-x-3">
								...
								<div className="flex-1 min-w-0">
									...
									<p className="text-xs text-gray-400 truncate">Active chat session</p>
								</div>
							</div>
						</button>
					);
